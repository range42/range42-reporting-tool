...
from app.routes.v1 import attachments as attachments_route
...
from app.routes.v1 import evaluation_finalize as evaluation_finalize_route
...
from app.routes.v1 import reports as reports_route
...
def create_app() -> FastAPI:
    ...
    for r in (
        ...
        evaluation_finalize_route.router,
    ):
