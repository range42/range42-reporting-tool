...
class Report(Base, UUIDMixin, TimestampMixin, MetadataMixin):
    ...
    # No index=True here: indexes are created explicitly in the migration, matching the repo
    # convention. index=True would make Alembic autogenerate a second, conflicting index.
    ...
    # NULL or single-entry = single-step default.
    ...
    # Sole writer: app/services/scoring/rollup.py. No other code path may set these two.
